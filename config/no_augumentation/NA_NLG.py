...
path.project_path = '/home/lab530/KenYu/visualDet3D/NA_NLG' # "/path/to/visualDet3D/workdirs" # or other path for pickle files, checkpoints, tensorboard logging and output files.
