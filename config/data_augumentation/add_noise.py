...
path.project_path = '/home/lab530/KenYu/visualDet3D/exp_output/data_augumentation/add_photo_dis' # "/path/to/visualDet3D/workdirs" # or other path for pickle files, checkpoints, tensorboard logging and output files.
...
data.train_augmentation = [
    ...
    edict(type_name='RandomEigenvalueNoise'),
