...
path.project_path = '/home/lab530/KenYu/visualDet3D/coordConv_C_exp' # "/path/to/visualDet3D/workdirs" # or other path for pickle files, checkpoints, tensorboard logging and output files.
...
head_layer = edict(
    num_features_in=1026, # For CoordConv C
