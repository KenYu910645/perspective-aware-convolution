'''
This anchor create 20 anchor per pixel and do minimal change to the gac_original code
However, the cover rate is only 78% currently 
TODO: add more anchor to a pixel, maybe 32 at least, in order to increase Best possibel Recall
'''
