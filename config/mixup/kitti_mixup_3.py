...
## path
path = edict()
path.data_path = '/home/lab530/KenYu/kitti_mixup_3/training'# "/data/kitti_obj/training" # used in visualDet3D/data/.../dataset
path.test_path = '/home/lab530/KenYu/kitti_mixup_3/testing' # "/data/kitti_obj/testing" # used in visualDet3D/data/.../dataset
...
path.project_path = '/home/lab530/KenYu/visualDet3D/exp_output/mixup/kitti_mixup_3' # "/path/to/visualDet3D/workdirs" # or other path for pickle files, checkpoints, tensorboard logging and output files.
# path.pretrained_checkpoint = "/home/lab530/KenYu/visualDet3D/exp_output/mixup/kitti_mixup_3/Mono3D/checkpoint/GroundAwareYolo3D_latest.pth"
...
data = edict(
    ...
    train_split_file = os.path.join(cfg.path.visualDet3D_path, 'data', 'kitti', 'kitti_mixup_3_split', 'train.txt'),
    val_split_file   = os.path.join(cfg.path.visualDet3D_path, 'data', 'kitti', 'kitti_mixup_3_split', 'val.txt'),
