...
## path
path = edict()
path.data_path = '/home/lab530/KenYu/kitti_seg_solid_10_obj_3_zJitter/training'# "/data/kitti_obj/training" # used in visualDet3D/data/.../dataset
path.test_path = '/home/lab530/KenYu/kitti_seg_solid_10_obj_3_zJitter/testing' # "/data/kitti_obj/testing" # used in visualDet3D/data/.../dataset
...
data = edict(
    ...
    train_split_file = os.path.join(cfg.path.visualDet3D_path, 'data', 'kitti', 'kitti_seg_solid_10_obj_3_zJitter_split', 'train.txt'),
    val_split_file   = os.path.join(cfg.path.visualDet3D_path, 'data', 'kitti', 'kitti_seg_solid_10_obj_3_zJitter_split', 'val.txt'),
