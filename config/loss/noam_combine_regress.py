...
path.project_path = '/home/lab530/KenYu/visualDet3D/exp_output/loss' # "/path/to/visualDet3D/workdirs" # or other path for pickle files, checkpoints, tensorboard logging and output files.
...
detector.backbone = edict(
    # resnext_mode_name = "resnext101_32x8d",
    depth=101,
    pretrained=True,
    frozen_stages=-1,
    num_stages=3,
...
head_loss = edict(
    ...
    # 21 term                  
    #                    x, y, w, h, cx, cy, cz, sin, cos, w,   h,   l,   hdg, o1, o2, o3, o4, o5, o6, o7, o8, 
    regression_weight = [1, 1, 1, 1, 1,  1,  3,  1,   1,   0.5, 0.5, 0.5, 1,    1,  1,  1,  1,  1,  1,  1,  1], #[x, y, w, h, cx, cy, z, sin2a, cos2a, w, h, l]
    #                      x, y, w, h, cx, cy, cz, sin, cos, w,   h,   l,   hdg
    # regression_weight = [1, 1, 1, 1, 1,  1,      1,   1,   0.5, 0.5, 0.5, 1]
)
head_test = edict(
...
head_layer = edict(
    ...
    num_reg_output=20, # 12
    cls_feature_size=512, # 512
    reg_feature_size=1024, # 1024
)

detector.head = edict(
    num_regression_loss_terms=21, # 13
