...
path.project_path = '/home/lab530/KenYu/visualDet3D/exp_output/nms_test/nms_0_5' # "/path/to/visualDet3D/workdirs" # or other path for pickle files, checkpoints, tensorboard logging and output files.
