...
path.project_path = '/home/lab530/KenYu/visualDet3D/exp_output/anchor_center3d' # "/path/to/visualDet3D/workdirs" # or other path for pickle files, checkpoints, tensorboard logging and output files.
...
head_loss = edict(
    ...
    anchor_generation = 'anchor_center3D', # 'bev_anchor' 'gac_anchor' 'bev_dense_anchor' 
)
