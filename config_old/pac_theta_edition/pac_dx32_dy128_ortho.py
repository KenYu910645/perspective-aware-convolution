...
path.project_path = '/home/lab530/KenYu/visualDet3D/exp_output/pac_theta_edition' # "/path/to/visualDet3D/workdirs" # or other path for pickle files, checkpoints, tensorboard logging and output files.
...
detector.head = edict(
    ...
    adpative_P2     = True, 
    offset_2d       = (32, 128),
    is_pac_bn_relu  = True, # True
    lock_theta_ortho= True,
