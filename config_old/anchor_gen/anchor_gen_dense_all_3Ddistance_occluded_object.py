...
data = edict(
    ...
    max_occlusion = 999, # 2, 999, # disable filting object
    min_z        =  -999, # 3, -999,
)
...
head_loss = edict(
    ...
    anchor_assignment = '3Ddistance', # 'maxIoU', 'L1distance', '3Ddistance'
    anchor_generation = 'bev_dense_anchor', # 'bev_anchor' 'gac_anchor' 'bev_dense_anchor' 
)
head_test = edict(
