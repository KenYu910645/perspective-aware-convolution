...
path.project_path = '/home/lab530/KenYu/visualDet3D/exp_output/data_augumentation' # "/path/to/visualDet3D/workdirs" # or other path for pickle files, checkpoints, tensorboard logging and output files.
...
data.train_augmentation = [
    ...
    # edict(type_name='RandomZoom', keywords=edict(scale_range=(0.8, 1.2))),
    edict(type_name='RandomJit', keywords=edict(jit_upper_bound=0.03)),
