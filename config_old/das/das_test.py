...
path.project_path = '/home/lab530/KenYu/visualDet3D/exp_output/das' # "/path/to/visualDet3D/workdirs" # or other path for pickle files, checkpoints, tensorboard logging and output files.
...
# out-indices 0 = [8, 256, 72, 320] # 1/4
# out-indices 1 = [8, 512, 36, 160] # 1/8
# out-indices 2 = [8, 1024, 18, 80] # 1/16
# out-indices 3 = [8, 2048, 9,  40] # 1/32
...
anchors = edict(
        {
            ...
            'is_das': detector.is_das,
            'external_anchor_path': "/home/lab530/KenYu/visualDet3D/anchor/kmeans/anchor_32/",
            'anchor_prior': True, # This enable the using the pre-processing generated mean and std file
        }
    )
