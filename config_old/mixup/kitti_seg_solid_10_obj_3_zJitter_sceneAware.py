...
## path
path = edict()
path.data_path = '/home/lab530/KenYu/kitti_seg_solid_10_obj_3_zJitter_sceneAware/training'# "/data/kitti_obj/training" # used in visualDet3D/data/.../dataset
path.test_path = '/home/lab530/KenYu/kitti_seg_solid_10_obj_3_zJitter_sceneAware/testing' # "/data/kitti_obj/testing" # used in visualDet3D/data/.../dataset
