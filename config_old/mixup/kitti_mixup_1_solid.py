...
## path
path = edict()
path.data_path = '/home/lab530/KenYu/kitti_mixup_1_solid/training'# "/data/kitti_obj/training" # used in visualDet3D/data/.../dataset
path.test_path = '/home/lab530/KenYu/kitti_mixup_1_solid/testing' # "/data/kitti_obj/testing" # used in visualDet3D/data/.../dataset
...
path.project_path = '/home/lab530/KenYu/visualDet3D/exp_output/mixup/kitti_mixup_1_solid' # "/path/to/visualDet3D/workdirs" # or other path for pickle files, checkpoints, tensorboard logging and output files.
...
data = edict(
    ...
    train_split_file = os.path.join(cfg.path.visualDet3D_path, 'data', 'kitti', 'kitti_mixup_1_split', 'train.txt'),
    val_split_file   = os.path.join(cfg.path.visualDet3D_path, 'data', 'kitti', 'kitti_mixup_1_split', 'val.txt'),
